    ...
    <aside class="main_sidebar">
        <ul>
            ...
            <li><i class="fa fa-lock"></i><a href="logout.html">Logout</a></li>
                    ...
                    <div class="tbl">
                        <table><tr><th>Uploaded By</th><th>Document Name</th><th></th></tr>
                        <c:forEach items="${shared}" var="i">
                                <tr><td>${i.sharedby}</td><td>${i.docname}</td><td><a href="request.html?fileid=${i.id}&email=<%=session.getAttribute("em")%>">Request File</a></td></tr>
