    ...
    <aside class="main_sidebar">
        <ul>
            ...
            <li><i class="fa fa-lock"></i><a href="logout.html">Logout</a></li>
                    ...
                    <div class="tbl">
                        <table><tr><th>Name</th><th>Email</th><th>Company</th><th>Phone</th><th>Address</th><th>Approve</th></tr>
                            <c:forEach items="${list}" var="i">
                                <tr><td>${i.name}</td><td>${i.email}</td><td>${i.cname}</td><td>${i.phone}</td><td>${i.address} ${i.address2}</td><td><a href="changestatus.html?Id=${i.id}"><span class="fa fa-check-circle-o"></span></a></td></tr>
