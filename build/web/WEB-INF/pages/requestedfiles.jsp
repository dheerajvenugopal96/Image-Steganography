    ...
    <aside class="main_sidebar">
        <ul>
            ...
            <li><i class="fa fa-lock"></i><a href="logout.html">Logout</a></li>
                    ...
                    <div class="tbl">
                        <table><tr><th>Requested Doc</th><th>Requested By</th><th></th></tr>
                                    <c:forEach items="${request}" var="i">
                                <tr><td>${i.docname}</td><td>${i.requestby}</td><td><a href="send.html?fileid=${i.id}">Send File</a></td></tr>
                                    </c:forEach>
